...
public class TableSourceData {
    ...
    private SimpleStringProperty requestsTimeInSystem;
    private SimpleStringProperty requestsWaitingTime;
    private SimpleStringProperty requestsProcessTime;
    ...
    public TableSourceData(String sourceIndex, String numberOfRequests, String numberOfDoneRequests,
    ...
    public void setRequestsTimeInSystem(String requestsTimeInSystem) {
        this.requestsTimeInSystem.set(requestsTimeInSystem);
    }

    public void setRequestsWaitingTime(String requestsWaitingTime) {
        this.requestsWaitingTime.set(requestsWaitingTime);
    }

    public void setRequestsProcessTime(String requestsProcessTime) {
        this.requestsProcessTime.set(requestsProcessTime);
    }
    ...
    public String getRequestsTimeInSystem() {
        return requestsTimeInSystem.get();
    }

    public String getRequestsWaitingTime() {
        return requestsWaitingTime.get();
    }

    public String getRequestsProcessTime() {
        return requestsProcessTime.get();
    }
